...
export default function AnonUserList(props) {
    ...
    return (
        <View style={styles.header} key={props.element.uuid_user}>
            ...
            <View key={props.element.uuid_user} style={styles.infoContainer}>
                    ...
                    <Text style={styles.infoText}>Secret Interests</Text>
                    <Text style={styles.infoText}>anonymous@email.com</Text>
                    <Text style={styles.infoText}>Secret Contact Number</Text>
            </View>
        </View>
    )
}
