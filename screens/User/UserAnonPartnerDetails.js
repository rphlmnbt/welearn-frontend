...
import invitationService from '../../services/invitation.service';
  ...
  export default function UserAnonPartnerDetails({route, navigation}) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.userdetails}>
                <View style={{marginTop: '15%'}}>
                    <UserInfo profilePic={null} firstName={"Anonymous"} lastName={null} course={user.user_detail.course} yearLevel={user.user_detail.year_level} interest={"Secret Interest"} isActive={user.isActive} />
                </View>
